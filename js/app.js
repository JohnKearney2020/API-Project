// var lat = "29.7895214"
// var lon = "-95.5673086"
function callRestaurantAPI(midPointLat, midPointLng) {
    // console.log('call restaurant api called sucessfully');
    var arrayOfNearby = [];
    fetch(`https://developers.zomato.com/api/v2.1/geocode?lat=${midPointLat}&lon=${midPointLng}`, {
            headers: {
        ...
        .then((res_array) => {
            ...
            arrayOfNearby = res_array.nearby_restaurants
            // return arrayOfNearby;
